<?php
       ...
       $faucetsystem = new FaucetSystem($api_fs, $btc);
       $result = $faucetsystem->send($addy, $amount, $userip, "false");
       if ($result["success"] === true){
       
           $msg = "ua=$addy&s=t&a=$amount&o=fs";
       ...
       if (!empty($ref) && $addy != $ref) {
           ...
           $reefResult = $faucetsystem->sendReferralEarnings($ref, $ref_amount, $userip);
       }
